        ...
        <div className="mx-auto w-full max-w-[1200px] px-5">
            ...
            <div className="flex flex-row flex-wrap items-center gap-4 pt-4">
                ...
                <div className="group relative">
                    <button
                        className="bg-size-[200px_200px] relative z-20 flex max-w-[200px] justify-between rounded-lg border border-title bg-background bg-[url(/noisy-texture-200x200.png)] bg-repeat p-3">
                    ...
                    <div
                        className="absolute left-0 top-0 z-10 h-full w-full rounded-[8px] border border-title p-3 transition-all group-hover:left-1 group-hover:top-1"></div>
                </div>
            </div>
